...
<head>
    ...
    <link rel="icon" type="image/png" href="<?= BASE_URL ?>/public/uploads/logopositivo.png">
        ...
        <div class="container">
            <nav class="navbar">
                ...
                <div class="nav-buttons">
                    <button class="btn btn-secondary" onclick="window.location.href='login'">INICIAR SESION</button>
                </div>
    ...
    <section class="hero">
        <div class="container">
            <div class="hero-content">
                <div class="hero-left">
                    <span class="hero-badge">Nunca dejes de aprender</span>

                    <h1 class="hero-title">
                        Gestiona y mejora tu institución académica.
                    </h1>
                    ...
                    <div class="hero-cta">
                        ...
                        <div class="reviews">
                            <div class="reviews-avatars">
                                <img src="public/assets/website/imgs/ellipse1.png" alt="Usuario 1">
                                <img src="public/assets/website/imgs/ellispe2.png" alt="Usuario 2">
                                <img src="public/assets/website/imgs/ellipse3.png" alt="Usuario 3">
                            </div>
                ...
                <div class="hero-right">
                    <div class="hero-image">
                        <img src="public/assets/website/imgs/heroimagen.png" alt="Estudiante feliz">
                    </div>
                    ...
                    <div class="stats-card">
                        ...
                        <div class="stats-info">
                            ...
                            <span class="stats-label">Estudiantes satisfechos</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section id="modulos" class="modulos">
        <div class="container">
            ...
            <div class="modulos-slider">
                <div class="modulos-track">
                    <!-- Card 1 - Estudiantes -->
                    <div class="modulo-card">
                        <div class="card-image">
                            <img src="public/assets/website/imgs/img1.png" alt="Estudiantes">
                    ...
                    <div class="modulo-card">
                        <div class="card-image">
                            <img src="public/assets/website/imgs/img2.png" alt="Acudientes">
                    ...
                    <div class="modulo-card">
                        <div class="card-image">
                            <img src="public/assets/website/imgs/img3.png" alt="Docentes">
                    ...
                    <div class="modulo-card">
                        <div class="card-image">
                            <img src="public/assets/website/imgs/img4.png" alt="Administradores">
    ...
    <section id="roles" class="roles">
        <div class="container">
            <h2 class="roles-title">
                Nuestra plataforma se adapta a cada rol educativo, brindando herramientas específicas para estudiantes,
                docentes, acudientes y administradores
            </h2>

            <div class="roles-grid">
                <!-- Card Estudiantes -->
                <div class="role-card">
                    <button class="role-badge">Estudiantes</button>
                    <p class="role-description">
                        Accede a tus clases, revisa actividades, calificaciones, calendario académico y mantente al
                        tanto de tu progreso académico en un solo lugar.
                    </p>
                </div>

                <!-- Card Acudientes -->
                <div class="role-card">
                    <button class="role-badge">Acudientes</button>
                    <p class="role-description">
                        Supervisa el avance académico de tu hijo(a), recibe notificaciones importantes y mantente
                        conectado con docentes e institución.
                    </p>
                </div>

                <!-- Card Docentes -->
                <div class="role-card">
                    <button class="role-badge">Docentes</button>
                    <p class="role-description">
                        Gestiona cursos, registra asistencia, calificaciones y actividades. Comunícate fácilmente con
                        estudiantes y acudientes.
                    </p>
                </div>
                ...
                <!-- Card Administración -->
                <div class="role-card">
                    <button class="role-badge">Administración</button>
                    <p class="role-description">
                        Administra la plataforma, usuarios, matrículas y reportes institucionales. Asegura el buen
    ...
    <section id="team" class="team">
        <div class="container">
            <div class="team-content">
                <div class="team-left">
                    <p class="team-text">
                        En SIADEMY, creemos que la educación merece herramientas digitales que realmente marquen la
                        diferencia. Por eso, detrás de nuestra plataforma hay un equipo comprometido, apasionado y con
                        visión de futuro.
                    </p>
                    <p class="team-text">
                        Somos estudiantes y desarrolladores en formación, unidos por un objetivo común: transformar la
                        gestión educativa con tecnología práctica, accesible y funcional.
                    </p>
                    <p class="team-text">
                        Cada módulo, cada función y cada detalle de SIADEMY ha sido pensado por un grupo que comprende
                        las necesidades reales de instituciones, docentes, estudiantes y padres. Nos esforzamos cada día
                        por crear soluciones que no solo funcionen, sino que también mejoren la experiencia educativa.
                    </p>
                </div>
                ...
                <div class="team-right">
                    <div class="team-cards">
                        <!-- Tarjeta Principal -->
                        <div class="id-card main-card">
                            <div class="card-header">
                                <div class="card-corner corner-left"></div>
                                <div class="card-corner corner-right"></div>
                            </div>
                            <div class="card-body">
                        ...
                        <!-- Tarjeta Secundaria -->
                        <div class="id-card secondary-card">
                            <div class="card-info">
                                <div class="info-item">
            ...
            <div class="training-content">
                <div class="training-left">
                    <div class="training-illustration">
                        <img src="public/assets/website/imgs/pana.png" alt="Capacitación">
                    </div>
                </div>
                    ...
                    <div class="training-features">
                        <div class="feature-item">
                            ...
                            <p class="feature-text">
                                Guías y talleres para que los docentes aprendan a manejar los módulos (asistencias,
                                calificaciones, actividades, reportes).
                            </p>
                        </div>
                        ...
                        <div class="feature-item">
                            ...
                            <p class="feature-text">
                                Cursos de actualización en nuevas metodologías educativas.
                            </p>
                        </div>
            ...
            <div class="pricing-card">
                <div class="pricing-content">
                    <div class="pricing-left">
                        <h2 class="pricing-title">Plan Institucional</h2>
                        ...
                        <div class="pricing-features">
                            <div class="pricing-item">
                                ...
                                <p class="pricing-text">
                                    Plan flexible según la cantidad de estudiantes matriculados
                                </p>
                            </div>
                            ...
                            <div class="pricing-item">
                                ...
                                <p class="pricing-text">
                                    <strong>Solo 5,000 COP por estudiante:</strong> paga solo por lo que usas.
                                </p>
                            </div>
                            ...
                            <div class="pricing-item">
                                ...
                                <p class="pricing-text">
                                    Escalable y accesible: se adapta al crecimiento de tu institución.
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="pricing-right">
                        <img src="public/assets/website/imgs/image 6.png" alt="Estudiante feliz">
                    </div>
                </div>
    ...
    <section class="packages">
        <div class="container">
            <h2 class="packages-title">
                Siademy es una plataforma innovadora que facilita el seguimiento académico para tu Institución
                Educativa.
            </h2>
                ...
                <div class="packages-wrapper">
                    <div class="packages-track">
                        ...
                        <div class="package-card">
                            <div class="package-illustration">
                                <img src="public/assets/website/imgs/imgslider1.jpg" alt="Educación Virtual">
                            </div>
                            <div class="package-info">
                                <h3 class="package-title">Paquete basico de administracion institucional</h3>
                                <p class="package-description">
                                    Facilita la administración de estudiantes y docentes, incluye registro de
                                    matrículas, asistencia y reportes académicos básicos.
                                </p>
                                <div class="package-users">
                                    <div class="users-avatars">
                                        <img src="public/assets/website/imgs/imguserrr1.jpg" alt="Usuario 1">
                                        <img src="public/assets/website/imgs/imguserrr2.jpg" alt="Usuario 2">
                                        <img src="public/assets/website/imgs/imguserrr3.jpg" alt="Usuario 3">
                        ...
                        <div class="package-card">
                            <div class="package-illustration">
                                <img src="public/assets/website/imgs/imgslider2.jpg" alt="Gestión Avanzada">
                            </div>
                            <div class="package-info">
                                <h3 class="package-title">Paquete completo de gestión educativa</h3>
                                <p class="package-description">
                                    Incluye todas las funcionalidades del paquete básico más herramientas avanzadas de
                                    comunicación, foros, y análisis de datos académicos.
                                </p>
                                <div class="package-users">
                                    <div class="users-avatars">
                                        <img src="public/assets/website/imgs/imguserr1.jpg" alt="Usuario 1">
                                        <img src="public/assets/website/imgs/imguserr2.jpg" alt="Usuario 2">
                                        <img src="public/assets/website/imgs/imguserr3.jpg" alt="Usuario 3">
                        ...
                        <div class="package-card">
                            <div class="package-illustration">
                                <img src="public/assets/website/imgs/imgslider3.jpg" alt="Paquete Premium">
                            </div>
                            <div class="package-info">
                                <h3 class="package-title">Paquete premium institucional</h3>
                                <p class="package-description">
                                    Solución completa con personalización, soporte prioritario 24/7, integraciones con
                                    sistemas externos y capacitación continua del personal.
                                </p>
                                <div class="package-users">
                                    <div class="users-avatars">
                                        <img src="public/assets/website/imgs/imgperfil1.png" alt="Usuario 1">
                                        <img src="public/assets/website/imgs/imguser2.jpg" alt="Usuario 2">
                                        <img src="public/assets/website/imgs/imguser3.jpg" alt="Usuario 3">
