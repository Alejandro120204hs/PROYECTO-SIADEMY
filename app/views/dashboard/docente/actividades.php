    ...
    <div class="app hide-right" id="appGrid">
        ...
        <div class="topbar">
          ...
          <div class="topbar-actions">
            <button class="btn-action" id="btnNuevaActividad">
              <a href="<?= BASE_URL ?>/docente/agregar-actividad"><i class="ri-add-line"></i>
              Nueva Actividad</a>
            </button>
          </div>
        </div>
      ...
      <div class="actividades-filter-section">
        ...
        <section class="actividades-grid" id="actividadesGrid">
          ...
          <!-- CARD 1: Taller de Ecuaciones Cuadráticas -->
          <div class="actividad-card" data-estado="activa" data-periodo="1" data-curso="10a" 
              data-titulo="taller de ecuaciones cuadráticas" 
              data-descripcion="resolver 20 ejercicios de ecuaciones cuadráticas aplicando la fórmula general">
            <div class="actividad-card-header">
              <div class="actividad-tipo-badge taller">
                <i class="ri-file-text-line"></i>
                TALLER
              </div>
              <div class="actividad-estado-badge activa">
                Activa
              </div>
            </div>

            <div class="actividad-card-body">
              <h3>Taller de Ecuaciones Cuadráticas</h3>
              <p>Resolver 20 ejercicios de ecuaciones cuadráticas aplicando la fórmula general y factorización.</p>

              <div class="actividad-meta-grid">
                <div class="actividad-meta-item">
                  <i class="ri-book-line"></i>
                  <span><strong>10° A</strong></span>
                </div>
                <div class="actividad-meta-item">
                ...
                <div class="actividad-meta-item">
                  ...
                  <span>Cierre: <strong>25 Ene 2025</strong></span>
                </div>
                <div class="actividad-meta-item">
                  <i class="ri-percent-line"></i>
                  <span>Valor: <strong>20%</strong></span>
                </div>
              </div>
              ...
              <div class="actividad-progreso-section">
                <div class="actividad-progreso-header">
                  ...
                  <div class="actividad-progreso-stats">
                    <span class="entregadas">28/32</span>
                    <span class="pendientes">4 pendientes</span>
                  </div>
                </div>
                <div class="actividad-progreso-bar">
                  <div class="actividad-progreso-fill" style="width: 87%"></div>
                </div>
              </div>
            </div>

            <div class="actividad-card-footer">
              <button class="btn-actividad-primary btn-ver-detalle">
          ...
          <!-- CARD 2: Proyecto Final -->
          <div class="actividad-card" data-estado="activa" data-periodo="1" data-curso="10b" 
              data-titulo="proyecto final aplicaciones de derivadas" 
              data-descripcion="investigar y presentar 3 aplicaciones reales de las derivadas">
            <div class="actividad-card-header">
              <div class="actividad-tipo-badge proyecto">
            ...
            <div class="actividad-card-body">
              <h3>Proyecto Final: Aplicaciones de Derivadas</h3>
              <p>Investigar y presentar 3 aplicaciones reales de las derivadas en ingeniería, física o economía.</p>

              <div class="actividad-meta-grid">
                <div class="actividad-meta-item">
                  <i class="ri-book-line"></i>
                  <span><strong>10° B</strong></span>
                </div>
                <div class="actividad-meta-item">
                  <i class="ri-calendar-line"></i>
                  <span><strong>Período 1 - 2025</strong></span>
                ...
                <div class="actividad-meta-item">
                  <i class="ri-calendar-check-line"></i>
                  <span>Cierre: <strong>10 Feb 2025</strong></span>
                </div>
                <div class="actividad-meta-item">
                  <i class="ri-percent-line"></i>
                  <span>Valor: <strong>35%</strong></span>
                </div>
              </div>
              ...
              <div class="actividad-progreso-section">
                <div class="actividad-progreso-header">
                  <small>Entregas recibidas</small>
                  <div class="actividad-progreso-stats">
                    <span class="entregadas">22/30</span>
                    <span class="pendientes">8 pendientes</span>
                  </div>
                </div>
                <div class="actividad-progreso-bar">
                  <div class="actividad-progreso-fill" style="width: 73%"></div>
                </div>
              </div>
            </div>
          ...
          <!-- CARD 3: Quiz Trigonometría -->
          <div class="actividad-card" data-estado="cerradas" data-periodo="1" data-curso="9a" 
              data-titulo="quiz trigonometría" 
              data-descripcion="evaluación de identidades trigonométricas">
            <div class="actividad-card-header">
              <div class="actividad-tipo-badge quiz">
                <i class="ri-file-list-3-line"></i>
                QUIZ
              </div>
              <div class="actividad-estado-badge cerrada">
                Cerrada
              </div>
            </div>

            <div class="actividad-card-body">
              <h3>Quiz Trigonometría</h3>
              <p>Evaluación de identidades trigonométricas y resolución de triángulos.</p>

              <div class="actividad-meta-grid">
                <div class="actividad-meta-item">
                  <i class="ri-book-line"></i>
                  <span><strong>9° A</strong></span>
                </div>
                <div class="actividad-meta-item">
                  <i class="ri-calendar-line"></i>
                  <span><strong>Período 1 - 2025</strong></span>
                ...
                <div class="actividad-meta-item">
                  <i class="ri-calendar-check-line"></i>
                  <span>Cierre: <strong>20 Ene 2025</strong></span>
                </div>
                <div class="actividad-meta-item">
                  <i class="ri-percent-line"></i>
                  <span>Valor: <strong>15%</strong></span>
                </div>
              </div>
              ...
              <div class="actividad-progreso-section">
                <div class="actividad-progreso-header">
                  <small>Entregas recibidas</small>
                  <div class="actividad-progreso-stats">
                    <span class="entregadas">28/28</span>
                  </div>
                </div>
                <div class="actividad-progreso-bar">
                  <div class="actividad-progreso-fill" style="width: 100%"></div>
                </div>
              </div>
            </div>
          ...
          <!-- CARD 4: Tarea Gráficas -->
          <div class="actividad-card" data-estado="activas" data-periodo="1" data-curso="10a" 
              data-titulo="tarea gráficas de funciones" 
              data-descripcion="graficar 10 funciones diferentes identificando dominio y rango">
            <div class="actividad-card-header">
              <div class="actividad-tipo-badge tarea">
            ...
            <div class="actividad-card-body">
              <h3>Tarea: Gráficas de Funciones</h3>
              <p>Graficar 10 funciones diferentes identificando dominio, rango, interceptos y asíntotas.</p>
              ...
              <div class="actividad-meta-grid">
                ...
                <div class="actividad-meta-item">
                  <i class="ri-calendar-check-line"></i>
                  <span>Cierre: <strong>29 Ene 2025</strong></span>
                </div>
                <div class="actividad-meta-item">
                  <i class="ri-percent-line"></i>
                  <span>Valor: <strong>10%</strong></span>
                </div>
              </div>
              ...
              <div class="actividad-progreso-section">
                <div class="actividad-progreso-header">
                  <small>Entregas recibidas</small>
                  <div class="actividad-progreso-stats">
                    <span class="entregadas">15/32</span>
                    <span class="pendientes">17 pendientes</span>
                  </div>
                </div>
                <div class="actividad-progreso-bar">
                  <div class="actividad-progreso-fill" style="width: 47%"></div>
                </div>
              </div>
            </div>
          ...
          <!-- CARD 5: Examen Parcial -->
          <div class="actividad-card" data-estado="por-calificar" data-periodo="1" data-curso="10b" 
              data-titulo="examen parcial álgebra y funciones" 
              data-descripcion="evaluación escrita sobre todos los temas del primer período">
            <div class="actividad-card-header">
              <div class="actividad-tipo-badge examen">
                <i class="ri-file-paper-line"></i>
                EXAMEN
              </div>
              <div class="actividad-estado-badge por-calificar">
                Por Calificar
              </div>
            </div>

            <div class="actividad-card-body">
              <h3>Examen Parcial: Álgebra y Funciones</h3>
              <p>Evaluación escrita sobre todos los temas vistos en el primer período.</p>
              ...
              <div class="actividad-meta-grid">
                ...
                <div class="actividad-meta-item">
                  <i class="ri-calendar-check-line"></i>
                  <span>Cierre: <strong>28 Ene 2025</strong></span>
                </div>
                <div class="actividad-meta-item">
                  <i class="ri-percent-line"></i>
                  <span>Valor: <strong>40%</strong></span>
                </div>
              </div>
              ...
              <div class="actividad-progreso-section">
                <div class="actividad-progreso-header">
                  <small>Entregas recibidas</small>
                  <div class="actividad-progreso-stats">
                    <span class="entregadas">30/30</span>
                  </div>
                </div>
                <div class="actividad-progreso-bar">
                  <div class="actividad-progreso-fill" style="width: 100%"></div>
          ...
          <!-- CARD 6: Taller Geometría Analítica -->
          <div class="actividad-card" data-estado="calificadas" data-periodo="1" data-curso="9a" 
              data-titulo="taller geometría analítica" 
              data-descripcion="ejercicios sobre rectas circunferencias y parábolas">
            <div class="actividad-card-header">
              <div class="actividad-tipo-badge taller">
                <i class="ri-file-text-line"></i>
                TALLER
              </div>
              <div class="actividad-estado-badge calificada">
                Calificada
              </div>
            </div>

            <div class="actividad-card-body">
              <h3>Taller de Geometría Analítica</h3>
              <p>Ejercicios sobre rectas, circunferencias y parábolas en el plano cartesiano.</p>
              ...
              <div class="actividad-meta-grid">
                ...
                <div class="actividad-meta-item">
                  <i class="ri-calendar-check-line"></i>
                  <span>Cierre: <strong>26 Ene 2025</strong></span>
                </div>
                <div class="actividad-meta-item">
                  <i class="ri-percent-line"></i>
                  <span>Valor: <strong>25%</strong></span>
                </div>
              </div>
              ...
              <div class="actividad-progreso-section">
                <div class="actividad-progreso-header">
                  <small>Entregas recibidas</small>
                  <div class="actividad-progreso-stats">
                    <span class="entregadas">26/28</span>
                    <span class="pendientes">2 pendientes</span>
                  </div>
                </div>
                <div class="actividad-progreso-bar">
                  <div class="actividad-progreso-fill" style="width: 93%"></div>
                </div>
              </div>
            </div>
