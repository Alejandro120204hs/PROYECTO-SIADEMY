        ...
        <main class="main">
            ...
            <div class="quick-stats">
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-content">
                        ...
                        <strong class="stat-value"><?= $curso['cupo_maximo'] ?></strong>
                    </div>
                </div>
                <div class="stat-card">
                    ...
                    <div class="stat-content">
                        ...
                        <strong class="stat-value" style="color: <?= $cupoDisponible > 0 ? '#10b981' : '#ef4444' ?>"><?= $cupoDisponible ?></strong>
                    </div>
                </div>
                <div class="stat-card">
                    ...
                    <div class="stat-content">
                        ...
                        <strong class="stat-value"><?= number_format($porcentajeOcupacion, 1) ?>%</strong>
                    </div>
                </div>
            </div>
            ...
            <div class="academic-section" style="margin-bottom: 32px;">
                ...
                <?php else: ?>
                    <div style="text-align: center; padding: 60px 40px; background: rgba(79, 70, 229, 0.05); border-radius: 16px; margin: 0 28px;">
                        ...
                        <a href="<?= BASE_URL ?>/administrador/asignar-docentes?curso=<?= $id_curso ?>" class="btn-profile-action btn-primary-action" style="display: inline-flex;">
                            <i class="ri-user-add-line"></i>
            ...
            <div class="academic-section">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px; padding: 0 28px;">
                    ...
                    <a href="<?= BASE_URL ?>/administrador/registrar-matricula?curso=<?= $id_curso ?>" class="btn-profile-action btn-primary-action">
