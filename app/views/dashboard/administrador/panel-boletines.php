<?php
/**
 * Vista: Panel de Boletines — Rol Administrador
 * Variables del controlador:
 *   $modo                — 'lista' | 'boletin'
 *   $anio                — año lectivo actual
 *   $idInstitucion       — id de la institución (sesión)
 *
 * Modo lista:
 *   $cursos, $estudiantes, $stats, $idCursoFiltro, $busqueda
 *
 * Modo boletin:
 *   $idEstudiante, $boletin_estudiante, $boletin_periodos,
...
// Helpers de nota (modo boletín)
function adm_bol_notaBadge(string $estado): string {
    return match ($estado) {
...
function adm_bol_promClase(?float $p): string {
    ...
    <main class="main">
        ...
        <div class="topbar">
            <div class="topbar-left">
                ...
                <?php if ($modo === 'boletin'): ?>
                    <a href="<?= BASE_URL ?>/administrador/boletines" class="btn-back">
                        <i class="ri-arrow-left-line"></i>
                    </a>
                <?php endif; ?>
                <div class="title">
                    <?= $modo === 'lista' ? 'Boletines Académicos' : 'Boletín del Estudiante' ?>
                </div>
            </div>
        ...
        <!-- FILTROS -->
        <form method="GET" action="<?= BASE_URL ?>/administrador/boletines" class="filtros-bar">
            ...
            <?php if (!empty($busqueda) || !empty($idCursoFiltro)): ?>
                <a href="<?= BASE_URL ?>/administrador/boletines" class="btn-limpiar">
                ...
                <table class="estudiantes-table">
                    ...
                    <tbody>
                        <?php foreach ($estudiantes as $est): ?>
                            <tr onclick="window.location='<?= BASE_URL ?>/administrador/boletines?id=<?= (int)$est['id'] ?>'" style="cursor:pointer">
                                <td>
                                    <div class="est-cell">
                                ...
                                <td class="text-center">
                                    <a href="<?= BASE_URL ?>/administrador/boletines?id=<?= (int)$est['id'] ?>"
                    ...
                    <div class="periodo-stats">
                        <div class="stat-pill">
                            ...
                            <div>
                                ...
                                <strong class="stat-val <?= adm_bol_promClase($promP) ?>">
                                ...
                                <tbody>
                                    <?php foreach ($materias as $m): ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <?php if ($prom !== null): ?>
                                                    <span class="nota-badge <?= adm_bol_notaBadge($estadoNota) ?>"><?= number_format($prom, 1) ?></span>
                                                <?php else: ?>
...
<?php /* ══════════════════════════════════════════════════════════════════════
       SECCIÓN DE IMPRESIÓN — visible solo en @media print
       ══════════════════════════════════════════════════════════════════════ */ ?>
