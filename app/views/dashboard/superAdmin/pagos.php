<?php
  ...
  $superAdminPagosJsVersion = @filemtime(BASE_PATH . '/public/assets/dashboard/js/superAdmin/main-superAdmin-pagos.js') ?: time();
?>
...
<tr>
  ...
  <script src="<?= BASE_URL ?>/public/assets/dashboard/js/superAdmin/main-superAdmin-pagos.js?v=<?= $superAdminPagosJsVersion ?>"></script>
</body>
</html>