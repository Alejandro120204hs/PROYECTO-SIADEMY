   ...
   ?>
        ...
        <main class="main">
            ...
            <div class="container-fluid py-3">
                ...
                <form id="formWizard" action="<?= BASE_URL ?>/coordinador/guardar_estudiante" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-5">
                                <div class="mb-3 w-50">
                                    ...
                                    <select class="selector" name="tipo_documento" required>
