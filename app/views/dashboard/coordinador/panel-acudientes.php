   ...
   ?>
    ...
    <main class="main">
      <div class="topbar">
        ...
        <button class="btn-agregar-estudiante" onclick="window.location.href='coordinador/registrar-acudiente'">
        ...
        <table id="tablaEstudiantes" class="table table-dark table-hover">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="acciones">
                <button class="btn-action"><a href="<?= BASE_URL ?>/coordinador/detalle-acudiente">Ver</a></button>
                <button class="btn-action"><a href="<?= BASE_URL ?>/coordinador/editar-acudiente?id=<?= $acudiente['id'] ?>">Editar</a></button>
                <button class="btn-action"><a href="<?= BASE_URL ?>/coordinador/eliminar-acudiente?accion=eliminar&id=<?= $acudiente['id'] ?>"><i class="bi bi-trash3-fill"></i></a></button>
